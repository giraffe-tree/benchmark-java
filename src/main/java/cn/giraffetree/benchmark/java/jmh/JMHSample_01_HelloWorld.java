package cn.giraffetree.benchmark.java.jmh;
...
/**
 * from <a href="https://github.com/openjdk/jmh/blob/master/jmh-samples/src/main/java/org/openjdk/jmh/samples/JMHSample_01_HelloWorld.java">...</a>
 * 打包
 * mvn clean package
 * 执行
...
public class JMHSample_01_HelloWorld {
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                ...
                .result("JMHSample_01_HelloWorld.json")
